...
:microphone: [How risk and uncertainty are treated in some various fields](#abs-lundh) Torbjörn Lundh
...
:microphone: [The recognition and communication of nature-related risks and uncertainties under EU corporate sustainability reporting: the benefits, pitfalls, and gaps of current approaches](#abs-Kashyap) Shruti Kashyap 
...
:clipboard: [Educating Decision-Makers about Toxicological Risks and Uncertainties for Ethical Decisions](#abs-hellevik) Christina Carrozzo Hellevik
...
#### How risk and uncertainty are treated in some various fields \| Torbjörn Lundh, Mathematical Sciences, Chalmers and University of Gothenburg, Sweden {#abs-lundh}
...
i)  Covid-19, including some cultural differences in expressing uncertainty

ii) Setting limit values of environmental pollutants

iii) Combinatorial cancer treatments

iv) Medical compression therapy for edema and chronic leg wounds

v)  Existential risk of AI, e.g. P(doom).
...
#### Probabilistic evaluation of forensic evidence in Sweden \| Anders Nordgaard, Linköping University and National Forensic Centre, Sweden {#abs-nordgaard}
...
#### The recognition and communication of nature-related risks and uncertainties under EU corporate sustainability reporting: the benefits, pitfalls, and gaps of current approaches \| Shruti Kashyap, The Royal Swedish Academy of Sciences, Sweden {#abs-Kashyap}
...
Haasnoot, M., Kwakkel, J. H., Walker, W. E., & Ter Maat, J. (2013). Dynamic adaptive policy pathways: A method for crafting robust decisions for a deeply uncertain world. Global Environmental Change, 23(2), 485–498. https://doi.org/10.1016/j.gloenvcha.2012.12.006 [:arrow_up_small:](#abs-ochsner)

#### Educating Decision-Makers about Toxicological Risks and Uncertainties for Ethical Decisions\| Christina Carrozzo Hellevik, Department of International Business, Norwegian University of Science and Technology (NTNU) {#abs-hellevik}

[:arrow_up_small:](#abs-hellevik)
