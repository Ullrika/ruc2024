...
:bulb: [Interpersonal Bayesian Analysis: Foundations, Ethics, and Communication](#abs-kadane) Joseph (Jay) Kadane
...
:microphone: [Selecting the Right Decision Making Under Deep Uncertainty Approaches for Climate Adaptation Planning](#abs-logan) Tom Logan
...
:microphone: [Applications of Cyber Risk and Uncertainty Communication to Government Actors](#abs-griffith) Kevin Griffith

:microphone: [Teaching about risk in upper secondary school science: opportunities and obstacles](#abs-schenk) Linda Schenk

<!-- :microphone: [TBC](#abs-zander) Joakim Zander -->

:clipboard: [Prediction Markets for Likelihood Estimation and Understanding Risk Perceptions](#abs-bonin) Ben Bonin and Nate Clough
...
:clipboard: [Bayesian uncertainty analysis for wind energy systems](#abs-saxena) Isha Saxena

:clipboard: [Sink or Swim: Dynamic Adaptation Policy Pathways for a Coastal Railway](#abs-ochsner) Michelle Ochsner et al.

:clipboard: [Prioritising Risk Education in Secondary Schools: Perspectives, Practicalities, and Progress](#abs-duckett) Sarah Duckett

:clipboard: [(Un)certainty in a scientific conclusion and evidential probability](#abs-sahlin) Ullrika Sahlin
...
#### Selecting the Right Decision Making Under Deep Uncertainty Approaches for Climate Adaptation Planning \| Tom Logan, University of Canterbury, New Zealand {#abs-logan}
...
#### Applications of Cyber Risk and Uncertainty Communication to Government Actors \| Kevin Griffith, National Security Systems Analyst, Sandia National Laboratories, USA {#abs-griffith}

Communicating uncertainty within the policy-making process is important to effectively address societal challenges. This holds especially true for the constantly evolving landscape of cybersecurity; as trends emerge, vulnerabilities are discovered, and threat-actors deploy novel tactics. The U.S. Department of Homeland Security’s National Risk Management Center (NRMC) is tasked with reducing said cybersecurity risks to critical infrastructure across all sectors. To support this objective, the Risk Analytic Methods & Support (RAMS) team at Sandia Labs has developed a range of methods – both novel and adapted from other domains – to assess and communicate cyber risk. We present several different analysis products which communicate uncertainty that have been generated during Cyber Risk Framework (CRF), Prediction Market, Credit Rating, and Actuarial Approach use cases. This includes communicating uncertainty through analytical framing, order-of-magnitude estimates, geographic scale estimates, and likelihood of events. The use-cases and resulting analysis products exemplify a diverse set of possibilities to communicate uncertainty to and by government actors. These examples may serve as impetus for further investigation or adaptation to other non-cyber domains.[:arrow_up_small:](#sec-program)

#### Teaching about risk in upper secondary school science: opportunities and obstacles \| Linda Schenk, Karolinska Institutet, Sweden {#abs-schenk}

Socio-scientific issues (SSI) have become an established part of science education, aiming to teach students not only about content knowledge but also about the nature of science and to offer them practice in argumentation and decision making. In the 7-year multidisciplinary project, RiskEdu, several risk-oriented SSI-teaching modules in biology, chemistry, physics and natural science were iteratively developed. To which extent risk and how to assess it were formally introduced varied. Our results show that students can participate in a risk-oriented SSI-task without having detailed knowledge of risk assessment or risk as a concept. However, when introducing students to the risk assessment structure it also served as a scaffold for their argumentation. Through the lens of RiskEdu’s empirical findings and a review of the published SSI literature, I will discuss how SSIs present opportunities for leveraging risk in science education. However, there are also obstacles and if the aim is to foster a deeper understanding of risk and risk analysis, teachers need support in policy and curricula as well as tools and teaching resources targeting these aims. [:arrow_up_small:](#sec-program)

<!-- #### Title \| Joakim Zander, Lund University, Sweden {#abs-zander} -->

<!-- Abstract [:arrow_up_small:](#sec-program) -->

# Abstracts Posters

#### Prediction Markets for Likelihood Estimation and Understanding Risk Perceptions \| Ben Bonin and Nate Clough, National Security Systems Analyst, Sandia National Laboratories, USA {#abs-bonin}

Estimating event likelihood often requires elicitation of information from subject matter experts (SMEs). Relevant SMEs may be widely distributed, and perspectives may vary; it can be challenging to gather and synthesize this information in a systematic manner, leading to additional uncertainty. This is especially the case during dynamic, time-sensitive events like natural disasters, cyber-attacks, and geopolitical crises. Prediction markets leverage the “wisdom of the crowd” to assess the potential likelihood of event outcomes. Participants in such markets buy and trade “stocks” (using real or notional currency) tied to the outcome of a specific event; the value of the stock at a given time can be interpreted as an estimation of event likelihood, based on the collective judgment of the market, and can improve estimate accuracy and uncertainty communication. Real-world prediction markets facilitate trading on issues as diverse as election outcomes, economic trends, and geopolitical events; while some markets serve largely recreational purposes, others have been used to inform public and private sector decision-making.

This presentation will provide an overview of the design and trial application of the Critical Infrastructure Market for Expert Risk Assessment (CIMERA), a prototype prediction market supporting critical infrastructure (CI) risk analysis. CIMERA is intended to facilitate timely collection and aggregation of SME assessments on the prospective impacts to CI of emerging or in-progress high-consequence events. Additionally, CIMERA may be able to parse out likelihood estimates across multiple participant dimensions (i.e., public, academic, government), helping to better understand the differences in risk perceptions across various societal/demographic factors.

If trials demonstrate its utility, then a market like CIMERA can potentially streamline SME elicitation for organizations like the Department of Homeland Security (DHS) Cybersecurity and Infrastructure Security Agency’s National Risk Management Center (CISA/NRMC), augmenting other analytic data streams in support of risk analysis, management, and communication. [:arrow_up_small:](#sec-program)


#### Bayesian uncertainty analysis for wind energy systems \| Isha Saxena, Durham University, UK {#abs-saxena}
...
#### (Un)certainty in a scientific conclusion and evidential probability\| Ullrika Sahlin, Lund University, Sweden {#abs-sahlin}

I use examples from scientific assessments by the European Food Safety Authority (EFSA) and the OHAT framework as a starting point to discuss if evidential probabilities applies on current or emerging practices for expressing a group of scientific expert's (un)certainty in a conclusion. A characterisation of uncertainty in conclusions should provide an accurate description of the experts’ (un)certainty (faithfulness), taking into account all (identified) sources of uncertainty and all available evidence (completeness). Interval-valued evidential probabilities applies for probabilities of unique events or statements of (un)certainty conditional on the available evidence. It has been argued, that interval-valued evidential probabilities can be combined with Bayesian objective epistemology. From my examples and identified challenges when working with experts, I conclude that the subjective dimension of eliciting expert's (un)certainty is unavoidable, at the same time as there are practical examples leaning towards the framework interval-valued evidential probability and Bayesian epistemology. I invite a discussion if and how to bridge these two dimensions.  [:arrow_up_small:](#sec-program)

#### Sink or Swim: Dynamic Adaptation Policy Pathways for a Coastal Railway] Michelle Ochsner, Lund University, Sweden , Gunnel Göransson, Carl-William Palmqvist {#abs-ochsner}
